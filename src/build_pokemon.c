...
const species_t gGeneralTrainerSpreads[NUM_TRAINER_CLASSES][NUM_BADGE_OPTIONS][NUM_MONS_PER_BADGE] = {
    ...
    [CLASS_JUGGLER] = {
        ...
        [5] = {SPECIES_CHIMECHO, SPECIES_GASTLY, SPECIES_KIRLIA, SPECIES_MISDREAVUS, SPECIES_MIME_JR_G, SPECIES_GOTHORITA, SPECIES_DUOSION, SPECIES_SPOINK, SPECIES_SHEDINJA},
    ...
    [CLASS_ELITE_FOUR] = {
        ...
        [3] = {SPECIES_SHIELDON, SPECIES_PIKACHU_PHD, SPECIES_MIME_JR_G, SPECIES_SILVALLY_PSYCHIC, SPECIES_MIGHTYENA, SPECIES_SLOWPOKE_G, SPECIES_STUNKY, SPECIES_MAGEARNA_P, SPECIES_BAGON},
