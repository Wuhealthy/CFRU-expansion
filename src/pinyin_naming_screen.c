...
#undef EXT_CTRL_CODE_COLOR
#undef EXT_CTRL_CODE_HIGHLIGHT
#undef EXT_CTRL_CODE_SHADOW
...
#define TEXT_SKIP_DRAW (-1)
#define COPYWIN_FULL COPYWIN_BOTH
#ifndef TEXT_COLOR_DARK_GRAY
#define TEXT_COLOR_DARK_GRAY TEXT_COLOR_DARK_GREY
#endif
#ifndef TEXT_COLOR_LIGHT_GRAY
#define TEXT_COLOR_LIGHT_GRAY TEXT_COLOR_LIGHT_GREY
#endif
#define SE_BALL 23
#define BG_COORD_SET 0
#define ANIM_STD_GO_SOUTH 0

#define StartTimer1 ((void (*)(void))(0x08000559))
#define SeedRngAndSetTrainerId ((void (*)(void))(0x08000565))
#define InitStandardTextBoxWindows ((void (*)(void))(0x080F6C6D))
#define InitTextBoxGfxAndPrinters ((void (*)(void))(0x080F6C99))
#define Text_MonSentToBoxInSomeonesPC ((const u8 *)0x081A5CF1)
#define Text_MonSentToBoxInBillsPC ((const u8 *)0x081A5D31)
#define Text_MonSentToBoxSomeonesBoxFull ((const u8 *)0x081A5D6E)
#define Text_MonSentToBoxBillsBoxFull ((const u8 *)0x081A5DB1)
...
extern const u8 sPinyinNamingScreenBackgroundTiles[];
extern const u8 sPinyinNamingScreenBackgroundMap[];
extern const u16 sPinyinNamingScreenBackgroundPal[];
extern const u8 sPinyinCursorSmallTiles[512];
extern const u16 sPinyinCursorSmallPal[16];
extern const u8 sPinyinCursorButtonTiles[512];
extern const u16 sPinyinCursorButtonPal[16];
extern const u8 sPinyinCursorLongButtonTiles[1024];
extern const u8 sPinyinPCIconOffTiles[192];
extern const u16 sPinyinPCIconOffPal[16];
extern const u8 sPinyinPCIconOnTiles[192];

#define sPCIconOff_Gfx sPinyinPCIconOffTiles
#define sPCIconOn_Gfx sPinyinPCIconOnTiles
#define sPinyinCursorSmall_Gfx sPinyinCursorSmallTiles
#define sPinyinCursorButton_Gfx sPinyinCursorButtonTiles
#define sPinyinCursorLongButton_Gfx sPinyinCursorLongButtonTiles
#define sPinyinCursorSmall_Pal sPinyinCursorSmallPal
#define sPinyinCursorButton_Pal sPinyinCursorButtonPal

#define GetStringRightAlignXOffset(_fontId, _string, _maxWidth) ((_maxWidth) - GetStringWidth((_fontId), (_string), 0))
#define GetStringCenterAlignXOffset(_fontId, _string, _maxWidth) (((_maxWidth) - GetStringWidth((_fontId), (_string), 0)) / 2)
...
#define TEXT_BUFFER_LENGTH   ((POKEMON_NAME_LENGTH * 2) + 1)
...
#define PINYIN_ACTION_BUTTON_TEXT_SHIFT   2
...
struct NamingScreenData
{
    ...
    const u8 *candidates;
    u8 candidateCount;
    bool8 helpSystemEnabled;
    bool8 helpToggleWithRButtonDisabled;
    u8 textEntryAnimDelay;
    u8 textEntryAnimFrame;
    u8 deleteCursorFlashTimer;
    u8 debugFrameLogCount;
    u8 cursorSpriteIds[CURSOR_SPRITE_COUNT];
};

#define sNamingScreen (*(struct NamingScreenData **)0x0203998C)
...
static const u8 sText_PlayerNamePrompt[] = {0x09, 0xD9, 0x03, 0x0B, 0x09, 0x93, 0x11, 0x0E, 0xAC, 0xFF};
static const u8 sText_MonNamePrompt[] = {0x03, 0x0B, 0x09, 0x93, 0x11, 0x0E, 0xAC, 0xFF};
static const u8 sText_BoxNamePrompt[] = {0x04, 0xF6, 0x11, 0x0B, 0x03, 0x0B, 0x09, 0x93, 0x11, 0x0E, 0xAC, 0xFF};
static const u8 sText_RivalNamePrompt[] = {0x03, 0x79, 0x0C, 0x1B, 0x03, 0x0B, 0x09, 0x93, 0x11, 0x0E, 0xAC, 0xFF};
static const u8 sText_ModePinyin[] = {0x0A, 0x6F, 0x0F, 0x44, 0xFF};
static const u8 sText_ModeDirectUpper[] = {0xBB, 0xBC, 0xBD, 0xFF};
static const u8 sText_ModeDirectLower[] = {0xD5, 0xD6, 0xD7, 0xFF};
static const u8 sText_ModeDirectSymbols[] = {0xA2, 0xBA, 0xAC, 0xFF};
static const u8 sText_DirectHint[] = {0xC6, 0xBA, 0xCC, 0x00, 0x03, 0xB0, 0x0F, 0x03, 0xFF};
static const u8 sText_Backspace[] = {0x0B, 0x9C, 0x02, 0x7F, 0x0D, 0x8A, 0x11, 0x0E, 0xFF};
static const u8 sText_Ok[] = {0x0B, 0x37, 0x0B, 0x4F, 0xFF};
...
static const u8 sDirectKeyChars[DIRECT_PAGE_COUNT][PINYIN_KEY_COUNT] =
{
    ...
    },
    {
        ...
        CHAR_AMPERSAND, CHAR_LEFT_PAREN, CHAR_RIGHT_PAREN, CHAR_DBL_QUOT_LEFT, CHAR_DBL_QUOT_RIGHT, CHAR_SGL_QUOT_LEFT, CHAR_SGL_QUOT_RIGHT, CHAR_MALE, CHAR_FEMALE, CHAR_SPACE,
    },
};
...
static const u16 sPinyinTextPalette[16] = {0x0000, 0x7FFF, 0x294A, 0x5AD6, 0x001F, 0x3D7F, 0x03E0, 0x7FE0, 0x7C00, 0x7EBF, 0, 0, 0, 0, 0, 0};
static const u8 sText_MaleSymbol[] = {CHAR_MALE, EOS};
static const u8 sText_FemaleSymbol[] = {CHAR_FEMALE, EOS};
...
static const struct SpritePalette sPinyinCursorSpritePalettes[] =
{
    ...
    {NULL, SPRITE_INVALID_TAG}
};

static const struct SpritePalette sPCIconSpritePalette =
{
    sPinyinPCIconOffPal, PALTAG_PC_ICON
};
...
static void TruncateFontIdToFit(u8 *start, u8 *end, u32 fontId, u32 width);
...
static void MovePinyinCursor(s8 dx, s8 dy);
...
static void WaitSentToPCMessage(void);
static void NamingScreen_ShowBgs(void);
static void NamingScreen_ApplyDisplayState(void);

u8 DoNamingScreen_Pinyin(u8 templateNum, u8 *destBuffer, u16 monSpeciesOrPlayerGender, u16 monGender, u32 monPersonality, MainCallback returnCallback)
{
    if (templateNum >= NAMING_SCREEN_COUNT)
    {
        SetMainCallback2(returnCallback);
        return 0;
    }

    sNamingScreen = Calloc(sizeof(struct NamingScreenData));
    ...
    else
    {
        ...
        sNamingScreen->debugFrameLogCount = 0;
...
static void NamingScreen_Init(void)
{
    ...
    if (sNamingScreen->templateNum == NAMING_SCREEN_CHOOSE_NUMBER)
    {
        sNamingScreen->mode = MODE_DIRECT;
        sNamingScreen->directPage = DIRECT_PAGE_SYMBOLS;
    }
...
static void NamingScreen_InitBGs(void)
{
    ...
    REG_DISPCNT = DISPCNT_OBJ_1D_MAP | DISPCNT_OBJ_ON;
...
static void LoadGfx(void)
{
    LZDecompressVram(sPinyinNamingScreenBackgroundTiles, (void *)BG_CHAR_ADDR(0));
    CpuCopy16(sPinyinNamingScreenBackgroundMap, sNamingScreen->bg1TilemapBuffer, 32 * 20 * sizeof(u16));
...
static void LoadPalettes(void)
{
    u8 smallCursorPalSlot;
    u8 buttonCursorPalSlot;

    LoadPalette(sPinyinNamingScreenBackgroundPal, BG_PLTT_ID(0), PLTT_SIZE_4BPP);
    LoadPalette(sPinyinTextPalette, BG_PLTT_ID(14), PLTT_SIZE_4BPP);
    CpuCopy16(sPinyinNamingScreenBackgroundPal, &gPlttBufferUnfaded[BG_PLTT_ID(0)], PLTT_SIZE_4BPP);
    CpuCopy16(sPinyinNamingScreenBackgroundPal, &gPlttBufferFaded[BG_PLTT_ID(0)], PLTT_SIZE_4BPP);
    CpuCopy16(sPinyinNamingScreenBackgroundPal, (void *)(BG_PLTT + BG_PLTT_ID(0) * sizeof(u16)), PLTT_SIZE_4BPP);
    CpuCopy16(sPinyinTextPalette, &gPlttBufferUnfaded[BG_PLTT_ID(14)], PLTT_SIZE_4BPP);
    CpuCopy16(sPinyinTextPalette, &gPlttBufferFaded[BG_PLTT_ID(14)], PLTT_SIZE_4BPP);
    CpuCopy16(sPinyinTextPalette, (void *)(BG_PLTT + BG_PLTT_ID(14) * sizeof(u16)), PLTT_SIZE_4BPP);
    LoadSpritePalette(&sPCIconSpritePalette);
    LoadSpritePalettes(sPinyinCursorSpritePalettes);

    smallCursorPalSlot = IndexOfSpritePaletteTag(PALTAG_PINYIN_CURSOR_SMALL);
    buttonCursorPalSlot = IndexOfSpritePaletteTag(PALTAG_PINYIN_CURSOR_BUTTON);
    if (smallCursorPalSlot != 0xFF)
    {
        CpuCopy16(sPinyinCursorSmall_Pal, &gPlttBufferUnfaded2[smallCursorPalSlot * 16], PLTT_SIZE_4BPP);
        CpuCopy16(sPinyinCursorSmall_Pal, &gPlttBufferFaded2[smallCursorPalSlot * 16], PLTT_SIZE_4BPP);
        CpuCopy16(sPinyinCursorSmall_Pal, (void *)(OBJ_PLTT + smallCursorPalSlot * PLTT_SIZE_4BPP), PLTT_SIZE_4BPP);
    }
    if (buttonCursorPalSlot != 0xFF)
    {
        CpuCopy16(sPinyinCursorButton_Pal, &gPlttBufferUnfaded2[buttonCursorPalSlot * 16], PLTT_SIZE_4BPP);
        CpuCopy16(sPinyinCursorButton_Pal, &gPlttBufferFaded2[buttonCursorPalSlot * 16], PLTT_SIZE_4BPP);
...
static void UpdateCursorSprites(void)
{
    ...
    if (spriteId != MAX_SPRITES)
    {
        gSprites[spriteId].pos1.x = GetModeCursorX(GetCurrentModeButton()) + PINYIN_CURSOR_BUTTON_HALF_WIDTH;
        gSprites[spriteId].pos1.y = PINYIN_BUTTON_TOP + PINYIN_CURSOR_BUTTON_HALF_HEIGHT;
    ...
    if (sNamingScreen->deleteCursorFlashTimer != 0)
    {
        ...
        gSprites[spriteId].pos1.x = PINYIN_DELETE_BUTTON_LEFT + PINYIN_CURSOR_LONG_HALF_WIDTH;
        gSprites[spriteId].pos1.y = PINYIN_BUTTON_TOP + PINYIN_CURSOR_BUTTON_HALF_HEIGHT;
...
static u8 GetCandidatePageCount(void)
{
    ...
    count = 0;
    remaining = sNamingScreen->candidateCount;
    while (remaining != 0)
    {
        count++;
        if (remaining <= CANDIDATES_PER_PAGE)
            break;
        remaining -= CANDIDATES_PER_PAGE;
    }
...
static void MovePinyinCursor(s8 dx, s8 dy)
{
    ...
    if (dx != 0)
    {
        ...
        {
        case REGION_KEYS:
            candidateCount = GetKeyboardRowKeyCount(sNamingScreen->cursorY);
            if (dx < 0)
            {
                if (sNamingScreen->cursorX == 0)
                    sNamingScreen->cursorX = candidateCount - 1;
                else
            ...
            {
                sNamingScreen->cursorX++;
                if (sNamingScreen->cursorX >= candidateCount)
                    sNamingScreen->cursorX = 0;
            }
            break;
        case REGION_CANDIDATES:
...
static bool8 AddDirectCharacter(u8 ch)
{
    ...
    if (sNamingScreen->templateNum == NAMING_SCREEN_CHOOSE_NUMBER && (ch < CHAR_0 || ch > CHAR_9))
    {
        PlaySE(SE_ERROR);
        return FALSE;
    }
...
static void DrawTitle(void)
{
    ...
    if (sNamingScreen->templateNum == NAMING_SCREEN_CAUGHT_MON || sNamingScreen->templateNum == NAMING_SCREEN_NICKNAME)
    {
        ...
        end = buffer + StringLength(buffer);
        end = StringAppend(end, title);
        TruncateFontIdToFit(buffer, end, FONT_SMALL, 152);
        title = buffer;
    }
...
static void TruncateFontIdToFit(u8 *start, u8 *end, u32 fontId, u32 width)
{
    while (end > start && GetStringWidth(fontId, start, 0) > (s32)width)
        *--end = EOS;
}
...
static void DrawTextEntry(void)
{
    ...
    if (sNamingScreen->template->addGenderIcon && sNamingScreen->monGender != MON_GENDERLESS)
    {
        ...
        const u8 *gender = isFemale ? sText_FemaleSymbol : sText_MaleSymbol;
...
static void DrawKeyboard(void)
{
    ...
    x = 0;
    y = 0;
    textY = (sNamingScreen->mode == MODE_DIRECT && sNamingScreen->directPage == DIRECT_PAGE_SYMBOLS) ? 6 : 3;
    for (i = 0; i < PINYIN_KEY_COUNT; i++)
    {
        ...
        x += KEYBOARD_KEY_STEP_X;
        if (x >= PINYIN_KEYS_PER_ROW * KEYBOARD_KEY_STEP_X)
        {
            x = 0;
            y += KEYBOARD_KEY_STEP_Y;
        }
    }
...
static void DrawCandidates(void)
{
    ...
    if (sNamingScreen->mode != MODE_DIRECT && sNamingScreen->pinyinLength != 0)
    {
        ...
        for (i = 0; i < count; i++)
        {
            ...
            x += KEYBOARD_KEY_STEP_X;
            if (x >= CANDIDATE_COLS * KEYBOARD_KEY_STEP_X)
            {
                x = 0;
                y += KEYBOARD_KEY_STEP_Y;
            }
...
static void DrawControls(void)
{
    ...
    DrawControlText(GetModeButtonLabel(MODE_BUTTON_ABC), PINYIN_MODE_BUTTON_ABC_LEFT + 1, PINYIN_MODE_BUTTON_WIDTH);
    DrawControlText(GetModeButtonLabel(MODE_BUTTON_SYMBOLS), PINYIN_MODE_BUTTON_SYMBOL_LEFT, PINYIN_MODE_BUTTON_WIDTH);
    DrawControlText(sText_Backspace, PINYIN_DELETE_BUTTON_LEFT - 1, PINYIN_ACTION_BUTTON_WIDTH);
    DrawControlText(sText_Ok, PINYIN_OK_BUTTON_LEFT - 1, PINYIN_ACTION_BUTTON_WIDTH);
...
static void DrawControlText(const u8 *text, u8 left, u8 width)
{
    ...
    if (width == PINYIN_ACTION_BUTTON_WIDTH)
        x += PINYIN_ACTION_BUTTON_TEXT_SHIFT;
...
static void CreateInputTargetIcon(void)
{
    if (sNamingScreen->template->iconFunction >= ARRAY_COUNT(sIconFunctions))
        return;
...
static void NamingScreen_CreatePlayerIcon(void)
{
    ...
    spriteId = AddPseudoEventObject(rivalGfxId, SpriteCallbackDummy, INPUT_ICON_X, INPUT_PLAYER_ICON_Y, 0);
...
{
    {sPCIconOff_Gfx, sizeof(sPCIconOff_Gfx), 0},
    {sPCIconOn_Gfx, sizeof(sPCIconOn_Gfx), 0},
};
...
static void NamingScreen_CreateMonIcon(void)
{
    ...
    LoadMonIconPalettes();
    spriteId = CreateMonIcon(sNamingScreen->monSpecies, SpriteCallbackDummy, INPUT_ICON_X, INPUT_MON_ICON_Y, 0, sNamingScreen->monPersonality, TRUE);
    gSprites[spriteId].oam.priority = 3;
}
...
static void NamingScreen_CreateRivalIcon(void)
{
    ...
    spriteId = AddPseudoEventObject(EVENT_OBJ_GFX_RIVAL, SpriteCallbackDummy, INPUT_ICON_X, INPUT_PLAYER_ICON_Y, 0);
    gSprites[spriteId].oam.priority = 3;
    StartSpriteAnim(&gSprites[spriteId], ANIM_STD_GO_SOUTH);
}
...
static const struct NamingScreenTemplate *const sNamingScreenTemplates[] =
{
    ...
    [NAMING_SCREEN_CHOOSE_NUMBER] = &sChooseNumberNamingScreenTemplate,
    [NAMING_SCREEN_ENTER_PHRASE] = &sEnterPhraseNamingScreenTemplate,
    [NAMING_SCREEN_ENTER_PASSWORD] = &sEnterPasswordNamingScreenTemplate,
    [NAMING_SCREEN_ENTER_5_CHAR_PASSWORD] = &sEnter5CharPasswordNamingScreenTemplate,
    [NAMING_SCREEN_ENTER_SPECIES_NAME] = &sEnterSpeciesNamingScreenTemplate,
};
