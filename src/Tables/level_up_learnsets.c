...
static const struct LevelUpMove sArbokLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE( 1, MOVE_WRAP),           // 紧束
    LEVEL_UP_MOVE( 1, MOVE_POISONSTING),    // 毒针
    LEVEL_UP_MOVE( 1, MOVE_LEER),           // 瞪眼
    LEVEL_UP_MOVE( 1, MOVE_BITE),           // 咬住
    LEVEL_UP_MOVE( 1, MOVE_FIREFANG),       // 火焰牙
    LEVEL_UP_MOVE( 1, MOVE_ICEFANG),        // 冰冻牙
    LEVEL_UP_MOVE( 1, MOVE_THUNDERFANG),    // 雷电牙
    LEVEL_UP_MOVE(12, MOVE_GLARE),          // 大蛇瞪眼
    LEVEL_UP_MOVE(17, MOVE_SCREECH),        // 刺耳声
    LEVEL_UP_MOVE(20, MOVE_ACID),           // 溶解液
    LEVEL_UP_MOVE(27, MOVE_STOCKPILE),      // 蓄力
    LEVEL_UP_MOVE(27, MOVE_SWALLOW),        // 吞下
    LEVEL_UP_MOVE(27, MOVE_SPITUP),         // 喷出
    LEVEL_UP_MOVE(32, MOVE_ACIDSPRAY),      // 酸液炸弹
    LEVEL_UP_MOVE(39, MOVE_SLUDGEBOMB),     // 污泥炸弹
    LEVEL_UP_MOVE(44, MOVE_GASTROACID),     // 胃液
    LEVEL_UP_MOVE(48, MOVE_BELCH),          // 打嗝
    LEVEL_UP_MOVE(51, MOVE_HAZE),           // 黑雾
    LEVEL_UP_MOVE(56, MOVE_COIL),           // 盘蜷
    LEVEL_UP_MOVE(63, MOVE_GUNKSHOT),       // 垃圾射击
	LEVEL_UP_END,
};
...
static const struct LevelUpMove sSandslashLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_CRUSHCLAW),      // 撕裂爪
    LEVEL_UP_MOVE( 1, MOVE_SANDATTACK),     // 泼沙
    LEVEL_UP_MOVE( 1, MOVE_POISONSTING),    // 毒针
    LEVEL_UP_MOVE( 1, MOVE_DEFENSECURL),    // 变圆
    LEVEL_UP_MOVE( 9, MOVE_ROLLOUT),        // 滚动
    LEVEL_UP_MOVE(12, MOVE_FURYCUTTER),     // 连斩
    LEVEL_UP_MOVE(15, MOVE_RAPIDSPIN),      // 高速旋转
    LEVEL_UP_MOVE(18, MOVE_BULLDOZE),       // 重踏
    LEVEL_UP_MOVE(21, MOVE_SWIFT),          // 高速星星
    LEVEL_UP_MOVE(26, MOVE_FURYSWIPES),     // 乱抓
    LEVEL_UP_MOVE(31, MOVE_SANDTOMB),       // 流沙深渊
    LEVEL_UP_MOVE(36, MOVE_SLASH),          // 劈开
    LEVEL_UP_MOVE(41, MOVE_DIG),            // 挖洞
    LEVEL_UP_MOVE(46, MOVE_GYROBALL),       // 陀螺球
    LEVEL_UP_MOVE(51, MOVE_SWORDSDANCE),    // 剑舞
    LEVEL_UP_MOVE(56, MOVE_SANDSTORM),      // 沙暴
    LEVEL_UP_MOVE(61, MOVE_EARTHQUAKE),     // 地震
	LEVEL_UP_END,
};
...
static const struct LevelUpMove sNidoqueenLevelUpLearnset[] = {
	LEVEL_UP_MOVE( 0, MOVE_SUPERPOWER),     // 蛮力
    LEVEL_UP_MOVE( 1, MOVE_SUPERPOWER),     // 蛮力
    LEVEL_UP_MOVE( 1, MOVE_GROWL),          // 叫声
    LEVEL_UP_MOVE( 1, MOVE_POISONSTING),    // 毒针
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),        // 抓
    LEVEL_UP_MOVE( 1, MOVE_TAILWHIP),       // 摇尾巴
    LEVEL_UP_MOVE( 1, MOVE_FURYSWIPES),     // 乱抓
    LEVEL_UP_MOVE( 1, MOVE_TOXICSPIKES),    // 毒菱
    LEVEL_UP_MOVE( 1, MOVE_DOUBLEKICK),     // 二连踢
    LEVEL_UP_MOVE( 1, MOVE_BITE),           // 咬住
    LEVEL_UP_MOVE( 1, MOVE_HELPINGHAND),    // 帮助
    LEVEL_UP_MOVE( 1, MOVE_TOXIC),          // 剧毒
    LEVEL_UP_MOVE( 1, MOVE_FLATTER),        // 吹捧
    LEVEL_UP_MOVE( 1, MOVE_CRUNCH),         // 咬碎
...
static const struct LevelUpMove sNidokingLevelUpLearnset[] = {
	LEVEL_UP_MOVE( 0, MOVE_MEGAHORN),       // 超级角击
    LEVEL_UP_MOVE( 1, MOVE_MEGAHORN),       // 超级角击
    LEVEL_UP_MOVE( 1, MOVE_LEER),           // 瞪眼
    LEVEL_UP_MOVE( 1, MOVE_POISONSTING),    // 毒针
    LEVEL_UP_MOVE( 1, MOVE_PECK),           // 啄
    LEVEL_UP_MOVE( 1, MOVE_FOCUSENERGY),    // 聚气
    LEVEL_UP_MOVE( 1, MOVE_FURYATTACK),     // 乱击
    LEVEL_UP_MOVE( 1, MOVE_TOXICSPIKES),    // 毒菱
    LEVEL_UP_MOVE( 1, MOVE_DOUBLEKICK),     // 二连踢
    LEVEL_UP_MOVE( 1, MOVE_HORNATTACK),     // 角撞
    LEVEL_UP_MOVE( 1, MOVE_HELPINGHAND),    // 帮助
    LEVEL_UP_MOVE( 1, MOVE_TOXIC),          // 剧毒
    LEVEL_UP_MOVE( 1, MOVE_FLATTER),        // 吹捧
    LEVEL_UP_MOVE( 1, MOVE_POISONJAB),      // 毒击
    LEVEL_UP_MOVE( 1, MOVE_EARTHPOWER),     // 大地之力
	LEVEL_UP_END,
};
...
static const struct LevelUpMove sStarmieLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE( 1, MOVE_CHILLINGWATER),
	LEVEL_UP_MOVE( 1, MOVE_CHARGEBEAM),
	LEVEL_UP_MOVE( 1, MOVE_METEORBEAM),
	LEVEL_UP_MOVE( 1, MOVE_ICESPINNER),
...
static const struct LevelUpMove sEeveeLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE( 1, MOVE_HELPINGHAND),     // 帮助
	LEVEL_UP_MOVE( 1, MOVE_COVET),           // 渴望
	LEVEL_UP_MOVE( 5, MOVE_SANDATTACK),      // 泼沙
	LEVEL_UP_MOVE(10, MOVE_QUICKATTACK),     // 电光一闪
	LEVEL_UP_MOVE(15, MOVE_BABYDOLLEYES),    // 圆瞳
	LEVEL_UP_MOVE(20, MOVE_SWIFT),           // 高速星星
	LEVEL_UP_MOVE(25, MOVE_BITE),            // 咬住
	LEVEL_UP_MOVE(30, MOVE_COPYCAT),         // 仿效
	LEVEL_UP_MOVE(35, MOVE_BATONPASS),       // 接棒
	LEVEL_UP_MOVE(40, MOVE_TAKEDOWN),        // 猛撞
	LEVEL_UP_MOVE(45, MOVE_CHARM),           // 撒娇
	LEVEL_UP_MOVE(50, MOVE_DOUBLEEDGE),      // 舍身冲撞
	LEVEL_UP_MOVE(55, MOVE_LASTRESORT),      // 珍藏
	LEVEL_UP_END,
};
...
static const struct LevelUpMove sJolteonLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE( 1, MOVE_THUNDERSHOCK),
	LEVEL_UP_MOVE( 1, MOVE_STEELBEAM),
	LEVEL_UP_MOVE( 1, MOVE_HELPINGHAND),
	LEVEL_UP_MOVE( 1, MOVE_TACKLE),
	LEVEL_UP_MOVE( 1, MOVE_TAILWHIP),
	LEVEL_UP_MOVE( 5, MOVE_SANDATTACK),
...
static const struct LevelUpMove sAriadosLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE( 1, MOVE_SWORDSDANCE),
	LEVEL_UP_MOVE( 1, MOVE_POISONSTING),    // 毒针
    LEVEL_UP_MOVE( 1, MOVE_FELLSTINGER),    // 致命针刺
    LEVEL_UP_MOVE( 1, MOVE_ABSORB),         // 吸取
    LEVEL_UP_MOVE( 1, MOVE_STRINGSHOT),     // 吐丝
    LEVEL_UP_MOVE( 1, MOVE_BUGBITE),        // 虫咬
    LEVEL_UP_MOVE( 1, MOVE_FOCUSENERGY),    // 聚气
    LEVEL_UP_MOVE( 8, MOVE_INFESTATION),    // 纠缠不休
    LEVEL_UP_MOVE(12, MOVE_SCARYFACE),      // 可怕面孔
    LEVEL_UP_MOVE(15, MOVE_NIGHTSHADE),     // 黑夜魔影
    LEVEL_UP_MOVE(19, MOVE_SHADOWSNEAK),    // 影子偷袭
    LEVEL_UP_MOVE(23, MOVE_FURYSWIPES),     // 乱抓
    LEVEL_UP_MOVE(28, MOVE_SUCKERPUNCH),    // 突袭
    LEVEL_UP_MOVE(31, MOVE_AGILITY),        // 高速移动
    LEVEL_UP_MOVE(35, MOVE_PINMISSILE),     // 飞弹针
    LEVEL_UP_MOVE(41, MOVE_PSYCHIC),        // 精神强念
    LEVEL_UP_MOVE(46, MOVE_POISONJAB),      // 毒击
    LEVEL_UP_MOVE(50, MOVE_CROSSPOISON),    // 十字毒刃
    LEVEL_UP_MOVE(54, MOVE_STICKYWEB),      // 黏黏网
    LEVEL_UP_MOVE(59, MOVE_TOXICTHREAD),    // 毒丝
	LEVEL_UP_END,
};
...
static const struct LevelUpMove sLanturnLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE( 1, MOVE_LIGHTNINGBALL),
	LEVEL_UP_MOVE( 1, MOVE_EERIEIMPULSE),
	LEVEL_UP_MOVE( 1, MOVE_SUPERSONIC),
	LEVEL_UP_MOVE( 1, MOVE_WATERGUN),
	LEVEL_UP_MOVE( 1, MOVE_THUNDERWAVE),
...
static const struct LevelUpMove sCrawdauntLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE( 1, MOVE_HARDEN),         // 变硬
    LEVEL_UP_MOVE( 1, MOVE_TAUNT),
    LEVEL_UP_MOVE(12, MOVE_BUBBLEBEAM),     // 泡沫光线
    LEVEL_UP_MOVE(16, MOVE_KNOCKOFF),       // 拍落
    LEVEL_UP_MOVE(20, MOVE_DOUBLEHIT),      // 二连击
    LEVEL_UP_MOVE(24, MOVE_PROTECT),        // 守住
    LEVEL_UP_MOVE(28, MOVE_NIGHTSLASH),     // 暗袭要害
    LEVEL_UP_MOVE(34, MOVE_RAZORSHELL),     // 贝壳刃
    LEVEL_UP_MOVE(40, MOVE_SWORDSDANCE),    // 剑舞
    LEVEL_UP_MOVE(46, MOVE_CRUNCH),         // 咬碎
    LEVEL_UP_MOVE(52, MOVE_CRABHAMMER),     // 蟹钳锤
    LEVEL_UP_MOVE(58, MOVE_ENDEAVOR),       // 蛮干
    LEVEL_UP_MOVE(64, MOVE_GUILLOTINE),     // 极落钳
	LEVEL_UP_END,
};
...
static const struct LevelUpMove sGalvantulaLevelUpLearnset[] = {
	LEVEL_UP_MOVE( 0, MOVE_STICKYWEB),          // 进化时学习黏黏网
	LEVEL_UP_MOVE( 1, MOVE_STICKYWEB),          // 黏黏网
	LEVEL_UP_MOVE( 1, MOVE_ABSORB),             // 吸取
	LEVEL_UP_MOVE( 1, MOVE_FURYCUTTER),         // 连斩
	LEVEL_UP_MOVE( 1, MOVE_BUGBITE),            // 虫咬
	LEVEL_UP_MOVE( 1, MOVE_ELECTROWEB),         // 电网
	LEVEL_UP_MOVE(12, MOVE_STRINGSHOT),         // 吐丝
	LEVEL_UP_MOVE(16, MOVE_THUNDERWAVE),        // 电磁波
	LEVEL_UP_MOVE(20, MOVE_ELECTROBALL),        // 电球
	LEVEL_UP_MOVE(24, MOVE_AGILITY),            // 高速移动
	LEVEL_UP_MOVE(28, MOVE_SUCKERPUNCH),        // 突袭
	LEVEL_UP_MOVE(32, MOVE_SLASH),              // 劈开
	LEVEL_UP_MOVE(39, MOVE_DISCHARGE),          // 放电
	LEVEL_UP_MOVE(44, MOVE_SCREECH),            // 刺耳声
	LEVEL_UP_MOVE(50, MOVE_GASTROACID),         // 胃液
	LEVEL_UP_MOVE(56, MOVE_BUGBUZZ),            // 虫鸣
	LEVEL_UP_END,
};
...
static const struct LevelUpMove sKeldeoLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE( 1, MOVE_SECRETSWORD),      // 神秘之剑
	LEVEL_UP_MOVE( 7, MOVE_BUBBLEBEAM),       // 泡沫光线
	LEVEL_UP_MOVE(14, MOVE_QUICKGUARD),       // 快速防守
	LEVEL_UP_MOVE(21, MOVE_DOUBLEKICK),       // 二连踢
	LEVEL_UP_MOVE(28, MOVE_RETALIATE),        // 报仇
	LEVEL_UP_MOVE(35, MOVE_AQUATAIL),         // 水流尾
	LEVEL_UP_MOVE(42, MOVE_TAKEDOWN),         // 猛撞
	LEVEL_UP_MOVE(49, MOVE_SACREDSWORD),      // 圣剑
	LEVEL_UP_MOVE(56, MOVE_SWORDSDANCE),      // 剑舞
	LEVEL_UP_MOVE(63, MOVE_HYDROPUMP),        // 水炮
	LEVEL_UP_MOVE(70, MOVE_CLOSECOMBAT),      // 近身战
	LEVEL_UP_END,
};
...
static const struct LevelUpMove sWyrdeerLevelUpLearnset[] = {
	LEVEL_UP_MOVE( 0, MOVE_PSYSHIELDBASH),    // 屏障猛攻
	LEVEL_UP_MOVE( 1, MOVE_PSYSHIELDBASH),    // 屏障猛攻
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),           // 撞击
    LEVEL_UP_MOVE( 3, MOVE_LEER),             // 瞪眼
    LEVEL_UP_MOVE( 7, MOVE_ASTONISH),         // 惊吓
    LEVEL_UP_MOVE(10, MOVE_HYPNOSIS),         // 催眠术
    LEVEL_UP_MOVE(13, MOVE_STOMP),            // 踩踏
    LEVEL_UP_MOVE(16, MOVE_SANDATTACK),       // 泼沙
    LEVEL_UP_MOVE(21, MOVE_TAKEDOWN),         // 猛撞
    LEVEL_UP_MOVE(23, MOVE_CONFUSERAY),       // 奇异之光
    LEVEL_UP_MOVE(27, MOVE_CALMMIND),         // 冥想
    LEVEL_UP_MOVE(32, MOVE_ROLEPLAY),         // 扮演
    LEVEL_UP_MOVE(37, MOVE_ZENHEADBUTT),      // 意念头锤
    LEVEL_UP_MOVE(49, MOVE_IMPRISON),         // 封印
    LEVEL_UP_MOVE(55, MOVE_DOUBLEEDGE),       // 舍身冲撞
    LEVEL_UP_MOVE(62, MOVE_MEGAHORN),         // 超级角击
	LEVEL_UP_END
};		
...
static const struct LevelUpMove sTinkatonLevelUpLearnset[] = {
	...
	LEVEL_UP_MOVE( 1, MOVE_WOODHAMMER),
	LEVEL_UP_MOVE( 1, MOVE_FAIRYWIND),       // 妖精之风
    LEVEL_UP_MOVE( 1, MOVE_ASTONISH),        // 惊吓
    LEVEL_UP_MOVE( 5, MOVE_BABYDOLLEYES),    // 圆瞳
    LEVEL_UP_MOVE( 8, MOVE_METALCLAW),       // 金属爪
    LEVEL_UP_MOVE(11, MOVE_COVET),           // 渴望
    LEVEL_UP_MOVE(14, MOVE_ROCKSMASH),       // 碎岩
    LEVEL_UP_MOVE(17, MOVE_DRAININGKISS),    // 吸取之吻
    LEVEL_UP_MOVE(21, MOVE_SWEETKISS),       // 天使之吻
    LEVEL_UP_MOVE(24, MOVE_BRUTALSWING),     // 狂舞挥打
    LEVEL_UP_MOVE(27, MOVE_SLAM),            // 摔打
    LEVEL_UP_MOVE(31, MOVE_FLASHCANNON),     // 加农光炮
    LEVEL_UP_MOVE(35, MOVE_PLAYROUGH),       // 嬉闹
    LEVEL_UP_MOVE(39, MOVE_FAKEOUT),         // 击掌奇袭
    LEVEL_UP_MOVE(43, MOVE_FLATTER),         // 吹捧
    LEVEL_UP_MOVE(47, MOVE_SKITTERSMACK),    // 爬击
    LEVEL_UP_MOVE(52, MOVE_KNOCKOFF),        // 拍落
	LEVEL_UP_END
};
...
const struct LevelUpMove* const gLevelUpLearnsets[] =
{
	...
	[SPECIES_MR_MIME_MEGA] = sMrMimeLevelUpLearnset,
	...
	[SPECIES_WEEZING_MEGA] = sWeezingLevelUpLearnset,
	...
	[SPECIES_RATICATE_MEGA] = sAriadosLevelUpLearnset,
	...
	[SPECIES_NINETALES_MEGA] = sNinetalesLevelUpLearnset,
	...
	[SPECIES_ELECTRODE_MEGA] = sElectrodeLevelUpLearnset,
	[SPECIES_MAROWAK_MEGA] = sMarowakLevelUpLearnset,
	[SPECIES_STARMIE_MEGA] = sStarmieLevelUpLearnset,
	[SPECIES_JYNX_MEGA] = sJynxLevelUpLearnset,
	[SPECIES_TAUROS_MEGA] = sTaurosLevelUpLearnset,
	...
	[SPECIES_JUMPLUFF_MEGA] = sJumpluffLevelUpLearnset,
	...
	[SPECIES_DONPHAN_MEGA] = sDonphanLevelUpLearnset,
	[SPECIES_RAIKOU_MEGA] = sRaikouLevelUpLearnset,
	[SPECIES_ENTEI_MEGA] = sEnteiLevelUpLearnset,
	[SPECIES_SUICUNE_MEGA] = sSuicuneLevelUpLearnset,
	[SPECIES_LUGIA_MEGA] = sLugiaLevelUpLearnset,
	[SPECIES_HOOH_MEGA] = sHoOhLevelUpLearnset,
	[SPECIES_SLAKING_MEGA] = sSlakingLevelUpLearnset,
	[SPECIES_TORKOAL_MEGA] = sTorkoalLevelUpLearnset,
	[SPECIES_FLYGON_MEGA] = sFlygonLevelUpLearnset,
	[SPECIES_KINGDRAY_MEGA] = sKingdraLevelUpLearnset,
	...
	[SPECIES_DEOXYS_MEGA] = sDeoxysLevelUpLearnset,
	...
	[SPECIES_MISMAGIUS_MEGA] = sMismagiusLevelUpLearnset,
	...
	[SPECIES_PORYGONZ_MEGA] = sPorygonZLevelUpLearnset,
	[SPECIES_DUSKNOIR_MEGA] = sDusknoirLevelUpLearnset,
	...
	[SPECIES_ARCEUS_MEGA] = sArceusLevelUpLearnset,
	...
	[SPECIES_FLOETTE_MEGA] = sFloetteLevelUpLearnset,
	[SPECIES_MEOWSTIC_MEGA] = sMeowsticLevelUpLearnset,
	...
	[SPECIES_TYRANTRUM_MEGA] = sTyrantrumLevelUpLearnset,
	[SPECIES_AURORUS_MEGA] = sAurorusLevelUpLearnset,
	...
	[SPECIES_CRABMINBLE_MEGA] = sCrabominableLevelUpLearnset,
	[SPECIES_GOLISOPOD_MEGA] = sGolisopodLevelUpLearnset,
	[SPECIES_PYUKUMUKU_MEGA] = sPyukumukuLevelUpLearnset,
	...
	[SPECIES_GALVANTULA_A] = sGalvantulaLevelUpLearnset,
	[SPECIES_EXEGGUTOR_A] = sExeggutorALevelUpLearnset,
	[SPECIES_BANETTE_M] = sBanetteLevelUpLearnset,
	...
	[SPECIES_BANETTE_F] = sBanetteLevelUpLearnset,
	[SPECIES_WEEZING_G] = sWeezingGLevelUpLearnset,
	[SPECIES_LEDIAN_G] = sLedianLevelUpLearnset,
