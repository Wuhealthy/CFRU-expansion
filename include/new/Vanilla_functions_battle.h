...
//u8 __attribute__((long_call)) AbilityBattleEffects(u8 caseID, u8 bank, ability_t ability, u8 special, u16 move);
...
//void __attribute__((long_call)) RecordAbilityBattle(u8 bank, ability_t ability);
