...
#define gAbilityPopUpHelper (*((ability_t*) 0x203E03C))
#define gAbilityPopUpSpecies (*((u16*) 0x203E03E))
...
// gNewBS itself occupies 0x203E038..0x203E03B. The ability popup transfer
// fields live immediately after it and must remain contiguous because the
// controller copies them together as one four-byte block.
#define LAST_NEW_BATTLE_RAM_LOC_BEFORE_GNEWBS ((u8*) 0x203E038)
#define FIRST_NEW_BATTLE_RAM_LOC_AFTER_GNEWBS ((u8*) 0x203E03C)
#define LAST_NEW_BATTLE_RAM_LOC ((u8*) 0x203E040)
