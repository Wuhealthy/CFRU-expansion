...
#define ABILITY_LINGERINGAROMA 0x4D //Was ABILITY_AIRLOCK
...
#define ABILITY_MEGASOL 0x87
#define ABILITY_SONILATE 0x88
...
#define ABILITY_QUARKDRIVE 0xAF //Was ABILITY_TANGLINGHAIR
...
#define ABILITY_DESPERATESTRIKE 0xED
#define ABILITY_INTREPIDSWORD 0xEE
#define ABILITY_UNICORNPEGASUS 0xEF
...
#define ABILITY_EVAPORATE ABILITY_STORMDRAIN //依附于引水
#define ABILITY_DRILLBEAK ABILITY_MERCILESS
#define ABILITY_FOCUSBELT ABILITY_MERCILESS
#define ABILITY_REFRIGERATE ABILITY_AERILATE
#define ABILITY_PIXILATE ABILITY_AERILATE
#define ABILITY_GALVANIZE ABILITY_AERILATE
#define ABILITY_DRAGONIZE ABILITY_AERILATE
#define ABILITY_DAUNTLESSSHIELD ABILITY_INTREPIDSWORD
#define ABILITY_VITAL_SPIRIT ABILITY_INSOMNIA

#define ABILITIES_COUNT (ABILITY_PASTELVEIL + 1)

//Gen 9 Abilities Leeches
#define ABILITY_ANGERSHELL ABILITY_WEAKARMOR
#define ABILITY_HOSPITALITY ABILITY_WEAKARMOR
...
#define ABILITY_EARTHEATER ABILITY_VOLTABSORB
#define ABILITY_ELECTROMORPHOSIS ABILITY_COLORCHANGE
#define ABILITY_GOODASGOLD ABILITY_CLEARBODY
#define ABILITY_GUARDDOG ABILITY_INNERFOCUS
#define ABILITY_HADRONENGINE ABILITY_ELECTRICSURGE
#define ABILITY_MINDSEYE ABILITY_SCRAPPY
#define ABILITY_MYCELIUMMIGHT ABILITY_MOLDBREAKER
#define ABILITY_OPPORTUNIST ABILITY_DANCER
#define ABILITY_ORICHALCUMPULSE ABILITY_DROUGHT
#define ABILITY_POISONPUPPETEER ABILITY_PLUS
#define ABILITY_PROTOSYNTHESIS ABILITY_QUARKDRIVE
#define ABILITY_PURIFYINGSALT ABILITY_IMMUNITY
#define ABILITY_ROCKYPAYLOAD ABILITY_STEELWORKER
#define ABILITY_SEEDSOWER ABILITY_GRASSYSURGE
#define ABILITY_SHARPNESS ABILITY_STRONGJAW
#define ABILITY_SUPREMEOVERLORD ABILITY_HUGEPOWER
#define ABILITY_SUPERSWEETSYRUP ABILITY_INTIMIDATE
#define ABILITY_THERMALEXCHANGE ABILITY_STEAMENGINE
#define ABILITY_TOXICCHAIN ABILITY_POISONTOUCH
#define ABILITY_TOXICDEBRIS ABILITY_POISONPOINT
#define ABILITY_WELLBAKEDBODY ABILITY_STEAMENGINE
