...
enum
{
    ITEM_BAXCALIBURITE = 0x308,
    ITEM_TATSUGIRIITE,          // 0x309
    ITEM_RAICHUXITE,            // 0x30A
    ITEM_RAICHUYITE,            // 0x30B
    ITEM_GLIMMORAITE,           // 0x30C
    ITEM_SCOVILLAINITE,         // 0x30D
    ITEM_FALINKSITE,            // 0x30E
    ITEM_CLEFABLEITE,           // 0x30F
    ITEM_ZERAORAITE,            // 0x310
    ITEM_MAGEARNAITE,           // 0x311
    ITEM_DRAMPAITE,             // 0x312
    ITEM_GOLISOPODITE,          // 0x313
    ITEM_VICTREEBELITE,         // 0x314
    ITEM_CRABMINBLEITE,         // 0x315
    ITEM_ZYGARDEITE,            // 0x316
    ITEM_GOODRAITE,             // 0x317
    ITEM_HAWLUCHAITE,           // 0x318
    ITEM_DRAGALGEITE,           // 0x319
    ITEM_BARBARACLEITE,         // 0x31A
    ITEM_STARMIEITE,            // 0x31B
    ITEM_MALAMARITE,            // 0x31C
    ITEM_MEOWSTICITE,           // 0x31D
    ITEM_VAPOREONITE,           // 0x31E
    ITEM_JOLTEONITE,            // 0x31F
    ITEM_FLAREONITE,            // 0x320
    ITEM_ARTICUNOITE,           // 0x321
    ITEM_ZAPDOSITE,             // 0x322
    ITEM_MOLTRESITE,            // 0x323
    ITEM_DRAGONITEITE,          // 0x324
    ITEM_MEGANIUMITE,           // 0x325
    ITEM_TYPHLOSIONITE,         // 0x326
    ITEM_FERALIGATRITE,         // 0x327
    ITEM_FLOETTEITE,            // 0x328
    ITEM_PYROARITE,             // 0x329
    ITEM_ESPEONITE,             // 0x32A
    ...
    ITEM_RHYPERIORITE,          // 0x348
    ITEM_ELECTIVIREITE,         // 0x349
    ITEM_MAGMORTARITE,          // 0x34A
    ITEM_PORYGONZITE,           // 0x34B
    ITEM_DUSKNOIRITE,           // 0x34C
    ITEM_FROSLASSITE,           // 0x34D
    ITEM_HEATRANITE,            // 0x34E
    ITEM_DARKRAIITE,            // 0x34F
    ITEM_ARCEUSITE,             // 0x350
    ITEM_SERPERIORITE,          // 0x351
