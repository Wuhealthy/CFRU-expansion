...
#define SPECIES_SINISTCHA_J 0x4AA
#define SPECIES_EXEGGUTOR_J 0x4AB
...
#define SPECIES_SPIRITOMB_J 0x588
#define SPECIES_SINISTCHA 0x589
#define SPECIES_PANGORO_J 0x58A
...
{
    // ZA和原创MEGA
    SPECIES_RATICATE_MEGA = 0x5A0,
    SPECIES_ARBOK_MEGA,             // 0x5A1
    SPECIES_RAICHU_MEGA_X,          // 0x5A2
    SPECIES_RAICHU_MEGA_Y,          // 0x5A3
    SPECIES_SANDSLASH_MEGA,         // 0x5A4
    SPECIES_NIDOQUEEN_MEGA,         // 0x5A5
    SPECIES_NIDOKING_MEGA,          // 0x5A6
    SPECIES_CLEFABLE_MEGA,          // 0x5A7
    SPECIES_NINETALES_MEGA,         // 0x5A8
    SPECIES_WIGGLYTUFF_MEGA,        // 0x5A9
    SPECIES_VENOMOTH_MEGA,          // 0x5AA
    SPECIES_POLIWRATH_MEGA,         // 0x5AB
    SPECIES_VICTREEBEL_MEGA,        // 0x5AC
    SPECIES_GOLEM_MEGA,             // 0x5AD
    SPECIES_RAPIDASH_MEGA,          // 0x5AE
    SPECIES_DODRIO_MEGA,            // 0x5AF
    SPECIES_HYPNO_MEGA,             // 0x5B0
    SPECIES_ELECTRODE_MEGA,         // 0x5B1
    SPECIES_MAROWAK_MEGA,           // 0x5B2
    SPECIES_STARMIE_MEGA,           // 0x5B3
    SPECIES_JYNX_MEGA,              // 0x5B4
    SPECIES_TAUROS_MEGA,            // 0x5B5
    SPECIES_VAPOREON_MEGA,          // 0x5B6
    SPECIES_JOLTEON_MEGA,           // 0x5B7
    SPECIES_FLAREON_MEGA,           // 0x5B8
    SPECIES_ARTICUNO_MEGA,          // 0x5B9
    SPECIES_ZAPDOS_MEGA,            // 0x5BA
    SPECIES_MOLTRES_MEGA,           // 0x5BB
    SPECIES_DRAGONITE_MEGA,         // 0x5BC
    SPECIES_MEGANIUM_MEGA,          // 0x5BD
    SPECIES_TYPHLOSION_MEGA,        // 0x5BE
    SPECIES_FERALIGATR_MEGA,        // 0x5BF
    SPECIES_CROBAT_MEGA,            // 0x5C0
    SPECIES_JUMPLUFF_MEGA,          // 0x5C1
    SPECIES_ESPEON_MEGA,            // 0x5C2
    SPECIES_UMBREON_MEGA,           // 0x5C3
    SPECIES_GRANBULL_MEGA,          // 0x5C4
    SPECIES_SKARMORY_MEGA,          // 0x5C5
    SPECIES_KINGDRA_MEGA,           // 0x5C6
    SPECIES_DONPHAN_MEGA,           // 0x5C7
    SPECIES_RAIKOU_MEGA,            // 0x5C8
    SPECIES_ENTEI_MEGA,             // 0x5C9
    SPECIES_SUICUNE_MEGA,           // 0x5CA
    SPECIES_LUGIA_MEGA,             // 0x5CB
    SPECIES_HOOH_MEGA,              // 0x5CC
    SPECIES_SLAKING_MEGA,           // 0x5CD
    SPECIES_TORKOAL_MEGA,           // 0x5CE
    SPECIES_FLYGON_MEGA,            // 0x5CF
    SPECIES_KINGDRAY_MEGA,          // 0x5D0
    SPECIES_MILOTIC_MEGA,           // 0x5D1
    SPECIES_TROPIUS_MEGA,           // 0x5D2
    SPECIES_CHIMECHO_MEGA,          // 0x5D3
    SPECIES_ABSOL_MEGA_Z,           // 0x5D4
    SPECIES_DEOXYS_MEGA,            // 0x5D5
    SPECIES_TORTERRA_MEGA,          // 0x5D6
    SPECIES_INFERNAPE_MEGA,         // 0x5D7
    SPECIES_EMPOLEON_MEGA,          // 0x5D8
    SPECIES_STARAPTOR_MEGA,         // 0x5D9
    SPECIES_LUXRAY_MEGA,            // 0x5DA
    SPECIES_ROSERADE_MEGA,          // 0x5DB
    SPECIES_MISMAGIUS_MEGA,         // 0x5DC
    SPECIES_GARCHOMP_MEGA_Z,        // 0x5DD
    SPECIES_LUCARIO_MEGA_Z,         // 0x5DE
    SPECIES_MAGNEZONE_MEGA,         // 0x5DF
    SPECIES_RHYPERIOR_MEGA,         // 0x5E0
    SPECIES_ELECTIVIRE_MEGA,        // 0x5E1
    SPECIES_MAGMORTAR_MEGA,         // 0x5E2
    SPECIES_PORYGONZ_MEGA,          // 0x5E3
    SPECIES_DUSKNOIR_MEGA,          // 0x5E4
    SPECIES_FROSLASS_MEGA,          // 0x5E5
    SPECIES_HEATRAN_MEGA,           // 0x5E6
    SPECIES_DARKRAI_MEGA,           // 0x5E7
    SPECIES_ARCEUS_MEGA,            // 0x5E8
    SPECIES_SERPERIOR_MEGA,         // 0x5E9
    SPECIES_EMBOAR_MEGA,            // 0x5EA
    SPECIES_SAMUROTT_MEGA,          // 0x5EB
    SPECIES_EXCADRILL_MEGA,         // 0x5EC
    SPECIES_SCOLIPEDE_MEGA,         // 0x5ED
    SPECIES_SCRAFTY_MEGA,           // 0x5EE
    SPECIES_EELEKTROSS_MEGA,        // 0x5EF
    SPECIES_CHANDELURE_MEGA,        // 0x5F0
    SPECIES_HAXORUS_MEGA,           // 0x5F1
    SPECIES_GOLURK_MEGA,            // 0x5F2
    SPECIES_CHESNAUGHT_MEGA,        // 0x5F3
    SPECIES_DELPHOX_MEGA,           // 0x5F4
    SPECIES_GRENINJA_MEGA,          // 0x5F5
    SPECIES_PYROAR_MEGA,            // 0x5F6
    SPECIES_FLOETTE_MEGA,           // 0x5F7
    SPECIES_MEOWSTIC_MEGA,          // 0x5F8
    SPECIES_MALAMAR_MEGA,           // 0x5F9
    SPECIES_BARBARACLE_MEGA,        // 0x5FA
    SPECIES_DRAGALGE_MEGA,          // 0x5FB
    SPECIES_TYRANTRUM_MEGA,         // 0x5FC
    SPECIES_AURORUS_MEGA,           // 0x5FD
    SPECIES_HAWLUCHA_MEGA,          // 0x5FE
    SPECIES_GOODRA_MEGA,            // 0x5FF
    SPECIES_ZYGARDE_MEGA,           // 0x600
    SPECIES_CRABMINBLE_MEGA,        // 0x601
    SPECIES_GOLISOPOD_MEGA,         // 0x602
    SPECIES_PYUKUMUKU_MEGA,         // 0x603
    SPECIES_DRAMPA_MEGA,            // 0x604
    SPECIES_MAGEARNA_MEGA,          // 0x605
    SPECIES_ZERAORA_MEGA,           // 0x606
    SPECIES_MAGEARNA_P_MEGA,        // 0x607
    SPECIES_FALINKS_MEGA,           // 0x608
    SPECIES_WYRDEER_MEGA,           // 0x609
    SPECIES_SCOVILLAIN_MEGA,        // 0x60A
    SPECIES_GLIMMORA_MEGA,          // 0x60B
    SPECIES_TATSUGIRI_MEGA,         // 0x60C
    SPECIES_BAXCALIBUR_MEGA,        // 0x60D
    SPECIES_FEAROW_MEGA,            // 0x60E
    SPECIES_CRAWDAUNT_MEGA,         // 0x60F
    SPECIES_SHIFTRY_MEGA,           // 0x610
    SPECIES_TINKATON_MEGA,          // 0x611
    SPECIES_LANTURN_MEGA,           // 0x612
    SPECIES_WEEZING_MEGA,           // 0x613
    SPECIES_CLOYSTER_MEGA,          // 0x614
    SPECIES_MR_MIME_MEGA,           // 0x615
    SPECIES_TATSUGIRI_RED_MEGA,     // 0x616
